package com.example.movieapps2.core.di

import androidx.room.Room
import com.example.movieapps2.core.data.MovieRepository
import com.example.movieapps2.core.data.source.local.LocalDataSource
import com.example.movieapps2.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase : ByteArray = SQLiteDatabase.getBytes("bay".toCharArray())
